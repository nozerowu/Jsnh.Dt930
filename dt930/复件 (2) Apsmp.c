...
void work(void)
 {
    ...
    for(;;)
    {
     ...
     lcd_cls();
     for( x=0,y=1,cnt=0; cnt<6; y+=2,cnt++ )  Dsp_str(msg[cnt],y,x);
     code=getkey();   /*----  等待击键  -----*/
...
void collect(void)
 {
   ...
   W  lno,lno2;
   ER fn,fm,ret,Status,i,i1,j,k,fn2,fn3,flag1;
